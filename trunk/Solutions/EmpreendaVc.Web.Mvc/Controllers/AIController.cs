namespace EmpreendaVc.Web.Mvc.Controllers
{
    ...
    public class AIController : ControllerCustom
    {
        ...
        [Transaction]
        public void ComprarJogador(Clube clube)
        {
        ...
        [Transaction]
        public void VenderJogador(Clube clube)
        {
            var controle = controleRepository.GetAll().FirstOrDefault();
        ...
        [Transaction]
        public void VenderJogadorPorCaixa(Clube clube)
        {
