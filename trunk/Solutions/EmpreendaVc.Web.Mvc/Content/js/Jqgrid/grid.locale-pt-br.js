...
$.jgrid = {
	...
	search : {
	    ...
	    Find: "Procurar",
	    Reset: "Resetar",
	    odata : ['igual', 'diferente', 'menos', 'menor ou igual', 'maior', 'maior ou igual', 'começa com', 'não começa com', 'está na', 'não está na' , 'termina com', 'não termina com','contém','não contém', 'preenchido', 'não preenchido'],
